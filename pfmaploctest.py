...
particleList = randomParticlesBox(numparticles, np.zeros(dynamics.xdim,), np.array([oc._width*oc._celldim, oc._width*oc._celldim, 0, 0, 0, 0]))
pf = ParticleFilter(particleList, dynamics, lidar, k_neff)
...
while True:
    ...
    viz.graphParticles(pf._particleList, maxparticlesize, minparticlesize)
    viz.updateFrame()
